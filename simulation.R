...
output <- par_lapply(
  ...
  do_sim1,
  cond = cond_sim1,
  outputfile = "Simulation 1/sim1.csv",
  verbose = FALSE
)
end <- Sys.time()
...
output <- par_lapply(
  backend,
  1:nrow(cond_sim1_reestimation),
  do_sim1_reestimation,
  cond = cond_sim1_reestimation,
  outputfile = "Simulation 1/sim1_reestimation.csv",
  verbose = FALSE
)
end <- Sys.time()
...
output <- par_lapply(
  ...
  do_sim2,
  cond = cond_sim2,
  outputfile = "Simulation 2/sim2.csv",
  verbose = FALSE
)
end <- Sys.time()
